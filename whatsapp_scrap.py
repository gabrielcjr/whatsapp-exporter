...
class WhatsappScrap ():
    ...
    def __init__(self, chat_list: list, selected_date: str):
    ...
    def select_chat_by_name(self, chat_name, wait):
    ...
    def scroll_screen_to_top_and_copy(self, driver, one_day_prior):
    ...
    def process_web_element(self, element):
    ...
    def export_to_csv(self, list, selected_date, chat):
        messages_all_dates = []
